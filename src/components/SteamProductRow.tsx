...
const SteamProductRow: React.FC<SteamProductRowProps> = memo(
  ({ product, isActive, onHover, onHoverEnd }) => {
    ...
    return (
      ...
      >
        {/* ═══ Mobile layout (< sm): картинка + контент + CTA снизу ═══ */}
          ...
          <div className="flex-1 min-w-0 flex flex-col justify-between">
            ...
            <div className="flex items-center justify-between gap-2 mt-2">
              ...
              <button
                ...
                className={`flex-shrink-0 px-3 py-1.5 rounded-lg text-[11px] font-bold border transition-all duration-200 min-w-[72px] text-center ${
                  isFree
        ...
        {/* ═══ Desktop layout (≥ sm): капсула 120×56 + inline данные ═══ */}

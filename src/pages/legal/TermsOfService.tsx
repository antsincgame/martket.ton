...
export default function TermsOfService() {
  return (
    <div className="max-w-3xl mx-auto py-8">
      ...
      <p className="text-gray-500 text-sm mb-4">Effective: April 18, 2026 · Last updated: April 28, 2026</p>
      ...
      <div className="prose prose-invert prose-sm max-w-none space-y-6 text-gray-300">
        ...
        <section>
          ...
          <p><strong>IRS Form 1099-DA &amp; Broker Reporting.</strong> Beginning with tax year 2025, certain digital asset brokers are required to file Form 1099-DA reporting gross proceeds, with additional basis-reporting requirements phased in under applicable Treasury and IRS rules. The Company operates as a non-custodial marketplace interface and does not take possession, custody, or control of User digital assets at any time. Based on this non-custodial design, the Company does not currently take the position that it is required to file Form 1099-DA for peer-to-peer TON payments on the Platform. <strong>This position is subject to change</strong> if future legislation, regulations, or agency guidance expands reporting obligations for non-custodial marketplace operators. The Company will comply with applicable reporting requirements and will notify affected Users when required.</p>
        ...
        <section>
          ...
          <p><strong>SEC.</strong> The Platform is designed to operate as a non-custodial user interface for purchasing digital goods, not as an exchange, broker-dealer, investment adviser, or securities marketplace. The Platform: (a) does not custody User assets; (b) does not solicit or recommend specific investment transactions; (c) charges an objective, product-agnostic fee of {FEE}; (d) permits Users to initiate their own TON payments through their own wallets. Nothing on the Platform constitutes investment advice, a solicitation, or a recommendation to buy or sell any digital asset.</p>

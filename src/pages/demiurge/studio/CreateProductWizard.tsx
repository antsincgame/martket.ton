...
import {
  Upload, FileArchive, ChevronLeft, AlertCircle, CheckCircle, Loader2,
} from 'lucide-react';
        ...
        {phase !== 'idle' && phase !== 'error' && (
          <div className="rounded-lg border border-white/[0.06] bg-[#0A0A0A] p-4">
            <div className="flex items-center gap-3">
              {phase === 'done' ? (
                <CheckCircle className="w-5 h-5 text-[#00FF88] flex-shrink-0" aria-hidden />
              ) : (
              ...
              <div className="flex-1">
                <p className="text-white text-sm font-medium">
                  ...
                  {phase === 'uploading' && 'Uploading build to R2…'}
                  {phase === 'done' && 'Created — opening editor…'}
                </p>
                {result && (

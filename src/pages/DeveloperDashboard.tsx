      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
            ...
            <div className="text-2xl font-bold text-white mb-1">{userStats.donationsReceived} TON</div>
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
            ...
            <div className="text-2xl font-bold text-white mb-1">{(userStats.totalDownloads).toLocaleString()}</div>
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
            ...
            <div className="text-2xl font-bold text-white mb-1">{userStats.productsPublished}</div>
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
            ...
            <div className="text-2xl font-bold text-white mb-1">{userStats.avgRating}</div>
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
            ...
            <div className="text-2xl font-bold text-white mb-1">{userStats.totalReviews}</div>

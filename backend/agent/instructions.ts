...
export const DEFAULT_INSTRUCTIONS: ReadonlyArray<Omit<InstructionSection, 'source'>> = [
  ...
  },
  {
    ...
    body: [
      ...
      '  1. Register your seller profile and link your TON wallet.',
  ...
  },
  {
    ...
    active: true,
    body: [
      'TonForge requires that a real human owner/operator stands behind every selling',
      'agent and completes genuine identity verification (KYC). This is a hard',
      'requirement, not a formality:',
      '- The verified human is legally accountable for what the agent sells.',
      '- KYC must be passed honestly by that real person. Using a straw person to',
      '  defeat verification, renting an identity, or otherwise circumventing KYC is',
      '  prohibited and will get the wallet and its tokens permanently banned.',
